 ...
 */
@Stateless
@Path("basico/empresa/empresa-escritorio-contabil")
public class EmpresaEscritorioContabilController extends ForgeController {
    
    private final EmpresaEscritorioContabilServico servico;

    public EmpresaEscritorioContabilController() {
        this.servico = new EmpresaEscritorioContabilServico();
    }
