...
@Stateless
@Path("basico/endereco/endereco-cidade")
public class EnderecoCidadeController extends ForgeController {
    
    private final EnderecoCidadeServico servico;

    public EnderecoCidadeController() {
        this.servico = new EnderecoCidadeServico();
    }
