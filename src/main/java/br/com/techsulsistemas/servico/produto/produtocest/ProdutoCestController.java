...
@Stateless
@Path("basico/produto/produto-cest")
public class ProdutoCestController extends ForgeController {
    
    private final ProdutoCestServico servico;

    public ProdutoCestController() {
        this.servico = new ProdutoCestServico();
    }
