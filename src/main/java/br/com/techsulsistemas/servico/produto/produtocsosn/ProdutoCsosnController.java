...
@Stateless
@Path("basico/produto/produto-csosn")
public class ProdutoCsosnController extends ForgeController {
    private final ProdutoCsosnServico servico;

    public ProdutoCsosnController() {
        this.servico = new ProdutoCsosnServico();
    }
